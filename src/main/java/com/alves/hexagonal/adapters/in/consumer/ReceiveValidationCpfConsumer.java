package com.alves.hexagonal.adapters.in.consumer;

import com.alves.hexagonal.adapters.in.consumer.mapper.CustomerMessageMapper;
...
public class ReceiveValidationCpfConsumer {
    ...
    @KafkaListener(topics = "tp-cpf-validate", groupId = "alves")
